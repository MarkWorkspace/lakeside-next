    ...
    <div className="min-h-screen flex flex-col relative">
      ...
      <main className="flex-grow relative">
        ...
        <section className="py-24 px-6 md:px-12 bg-surface" id="location">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold tracking-tighter mb-12 text-neutral-900">Расположение и контакты</h2>
              ...
              <div className="lg:col-span-2 rounded-3xl overflow-hidden h-[500px] relative bg-neutral-200 group">
                ...
                <div className="absolute bottom-4 left-4 right-4 md:right-auto bg-white/95 backdrop-blur-md p-3 rounded-2xl shadow-xl flex flex-wrap gap-2 items-center z-10">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="px-3 py-1.5 bg-primary text-white text-xs font-bold rounded-lg hover:bg-neutral-800 transition-colors inline-flex items-center gap-1"
                  >
                    Яндекс Карты
                  </a>
                  <a 
                    href="yandexnavi://build_route_on_map?lat_to=55.828157&lon_to=37.124370"
                    className="px-3 py-1.5 bg-amber-500 text-white text-xs font-bold rounded-lg hover:bg-amber-600 transition-colors inline-flex items-center gap-1 md:hidden"
                  >
                    Навигатор
                  </a>
                  <a 
