...
export const faqData = [
  ...
  },
  {
    ...
    answer: "На территории КП действует собственная управляющая компания. Основные затраты – это содержание общего имущества, охрана и потребление ресурсов. За счет высокой энергоэффективности конструкций, а также современных технических решений (плита УШП, система вентиляции с рекуперацией тепла) даже в холодные зимние месяцы с учетом затрат на отопление платеж составлял в районе 15 000 рублей в месяц."
  },
  {
